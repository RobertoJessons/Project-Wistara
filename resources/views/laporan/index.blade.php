    ...
    <x-app-layout>
        ...
        <div class="flex-1 p-6">
            ...
            <form method="GET" action="{{ route('laporan.index') }}" class="mb-4">
                ...
                <!-- Tombol Download -->
                <button type="submit" formaction="{{ route('laporan.download') }}" class="px-4 py-2 bg-green-500 text-white rounded">Download</button>
            </form>
            ...
            <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700">
                ...
                <tbody>
                    @forelse($transaksi_penjualan as $laporan)
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300">{{ $laporan->tukar_poin ? 'Ya' : 'Tidak' }}</td>
                        </tr>
                    @empty
                        <tr>
